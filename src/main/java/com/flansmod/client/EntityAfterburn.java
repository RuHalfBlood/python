...
public class EntityAfterburn extends EntityFX {
   ...
   public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
      ...
      float scale = 0.8F - (float)super.particleAge * 0.13F;
      ...
      par1Tessellator.setColorRGBA_F(super.particleRed * (colorIntensity - (float)super.particleAge * 0.2F), super.particleGreen * (colorIntensity - (float)super.particleAge * 0.2F), super.particleBlue * colorIntensity, 1.0F - (float)super.particleAge * 0.1F);
