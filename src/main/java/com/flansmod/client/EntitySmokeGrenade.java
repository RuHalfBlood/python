...
public class EntitySmokeGrenade extends EntityFX {
   ...
   public void onUpdate() {
      ...
      super.motionY *= 0.99D;
      super.motionZ *= 0.99D;
      if(super.worldObj.isAnyLiquid(super.boundingBox)) {
         super.motionY = 1.0D;
      }
      ...
      if(this.dischargeTime < 0) {
         ...
         var9 = super.posY - super.prevPosY;
         var9 = super.posZ - super.prevPosZ;
         FlansMod.proxy.spawnParticle("flansmod.smokeburst", super.posX, super.posY, super.posZ, 0.0D, 0.0D, 0.0D);
         FlansMod.proxy.spawnParticle("flansmod.bigsmoke", super.posX, super.posY, super.posZ, 0.0D, 0.0D, 0.0D);
         this.setDead();
      }
      ...
      for(int i = 0; i < NUM; ++i) {
         ...
         FlansMod.proxy.spawnParticle("explode", super.prevPosX + dx * (double)i, super.prevPosY + dy * (double)i, super.prevPosZ + dz * (double)i, 0.0D, 0.0D, 0.0D);
      }
