...
import com.flansmod.common.driveables.mechas.EnumMechaToolType;
...
public class MechaItemType extends InfoType {
   ...
   public void reloadModel() {
      if(super.modelString != null) {
         this.model = (ModelMechaTool)FlansMod.proxy.loadModel(super.modelString, super.shortName, ModelMechaTool.class);
      }
