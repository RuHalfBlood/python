...
public class ArmourType extends InfoType {
   ...
   protected void read(String[] split, TypeFile file) {
      ...
      try {
         if(FMLCommonHandler.instance().getSide().isClient() && split[0].equals("Model")) {
            this.model = (ModelCustomArmour)FlansMod.proxy.loadModel(split[1], super.shortName, ModelCustomArmour.class);
   ...
   public void reloadModel() {
      this.model = (ModelCustomArmour)FlansMod.proxy.loadModel(super.modelString, super.shortName, ModelCustomArmour.class);
      if(this.model != null) {
         this.model.type = this;
      }
